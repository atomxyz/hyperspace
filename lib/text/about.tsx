...
export const aboutText = [
  { textLocation: "text-center", text: `Launching May 2023` },
  {
    textLocation: "text-left",
    text: (
      <p>
        Coming soon, your chance to name, own, and receive a digital certificate
        of a unique symmetrical object living in hyperspace. We will soon be
        giving you the chance to mint an Open Edition of these multidimensional
        NFTs. The money raised will be donated to Common Hope, an educational
        charity supporting and empowering children and their families in
        Guatemala through education.
      </p>
    ),
  },
  {
    ...
    text: (
      <p>
        ...
        be built by taking combinations of 9 basic symmetries called{" "}
        <i>
          a<sub>1</sub>
        </i>
        ,{" "}
  ...
  },
  {
    ...
    text: (
      <p>
        ...
        each other. For example if you do symmetry{" "}
        <i>
          a<sub>1</sub>
        </i>{" "}
        followed by{" "}
  ...
  },
  {
    ...
    text: (
      <p>
        A similar thing happens with objects we can see. Take a beer mat. Place
        it on the table. First rotate it 90 degrees clockwise then reflect or
        flip the mat in the vertical line running down the middle of the mat.
  ...
  {
    textLocation: "text-left",
    text: `If you would like to explore a little bit more of the mathematical
  ...
  },
  {
    ...
    text: (
      ...
      >
        ...
        functions of groups, Israel J. of Math 126 (2001), 269-288.
      </a>
    ),
  },
  {
    ...
    text: (
      <a
        ...
        rel="noreferrer"
      >
        Counting subgroups in nilpotent groups and points on elliptic curves, J.
        Reine Angew. Math. 549 (2002) 1-21.
      </a>
    ),
  },
  {
